...
const ROTATING_WORDS = ["distilled.", "simplified.", "exported.", "distilled."];
...
function CardVisual({ type }: { type: string }) {
  if (type === "waveform") return (
    <svg width="100%" height="80" viewBox="0 0 208 80" preserveAspectRatio="xMidYMid meet" aria-hidden="true">
      {WAVE_HEIGHTS.map((h, i) => (
        <rect
          key={i} x={i * 8} y={(80 - h) / 2} width="5" height={h} rx="2"
  ...
  if (type === "grid") return (
    <svg width="82" height="82" viewBox="0 0 82 82" aria-hidden="true">
      {Array.from({ length: 16 }, (_, i) => {
        ...
        const active = i === 10;
        return (
          <rect key={i} x={col * 22} y={row * 22} width="16" height="16" rx="3"
    ...
    <svg width="100%" height="84" viewBox="0 0 200 84" aria-hidden="true">
      {[160, 120, 180, 90, 150, 70, 140, 100].map((w, i) => (
        <rect key={i} x="0" y={i * 11 + 2} width={w} height="5" rx="2.5"
          fill={i === 2 ? "rgba(196,181,253,0.75)" : "rgba(255,255,255,0.15)"}
          className="va-line-bar"
  ...
  if (type === "arrow") return (
    <svg width="72" height="72" viewBox="0 0 72 72" fill="none" aria-hidden="true">
      <circle cx="36" cy="36" r="30" stroke="rgba(255,255,255,0.1)" strokeWidth="1.5" className="va-arrow-ring"/>
      <circle cx="36" cy="36" r="22" stroke="rgba(196,181,253,0.2)" strokeWidth="1" className="va-arrow-ring2"/>
      ...
      <main id="va-main">
        <section className="va-hero" aria-labelledby="va-hero-heading">
          <div className="va-hero-text">
            ...
            <h1 id="va-hero-heading" className="va-hero-name">
              Your footage,<br />
              <span className="va-hero-word" key={wordKey} aria-live="polite">
        ...
        <section className="va-cards-section" aria-label="Features">
          <div className="va-cards">
            {CARDS.map((card, i) => (
              <div className="va-card" key={card.phrase} style={{ animationDelay: `${0.1 + i * 0.12}s` }}>
